...
from vox.models.settings import VoxSettings, RecordingAudioBehavior
...
class SettingsDialog(QDialog):
    ...
    settings_changed = Signal(VoxSettings)

    def __init__(self, settings: VoxSettings, parent: Optional[QWidget] = None) -> None:
        ...
        self._edited_settings: Optional[VoxSettings] = None
