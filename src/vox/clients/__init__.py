...
from vox.clients.clipboard import (
    ClipboardClient,
    PasteStrategy,
    PasteboardSnapshot,
)
from vox.clients.key_event_monitor import (
    KeyEventMonitorClient,
    KeyEventMonitorToken,
    create_key_event_monitor,
)
from vox.clients.recording import (
    AudioInputDevice,
    Meter,
    RecordingClient,
)
from vox.clients.sound_effects import (
    SoundEffect,
    SoundEffectsClient,
)
from vox.clients.transcript_persistence import (
