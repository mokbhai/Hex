...
from vox.models.hotkey import HotKey, Key as HexKey, Modifier, ModifierKind, Modifiers
from vox.models.key_event import InputEvent, InputEventType, KeyEvent
from vox.hotkeys.processor import HotKeyProcessor, Output as ProcessorOutput
...
class KeyEventMonitorClient:
    ...
    def handle_hotkey_processor(
        ...
        Example:
            ...
            >>> from vox.hotkeys.processor import HotKeyProcessor
            >>> processor = HotKeyProcessor(
