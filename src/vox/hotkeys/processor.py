...
from vox.models.hotkey import HotKey, Modifiers, Key
...
class RecordingDecisionEngine:
    ...
    modifierOnlyMinimumDuration: float = VoxCoreConstants.modifierOnlyMinimumDuration
...
class HotKeyProcessor:
    ...
    minimum_key_time: float = VoxCoreConstants.defaultMinimumKeyTime
    ...
    doubleTapThreshold: float = VoxCoreConstants.doubleTapWindow
    pressAndHoldCancelThreshold: float = VoxCoreConstants.pressAndHoldCancelWindow
    ...
    def process(self, key_event: KeyEvent) -> Optional[Output]:
        ...
        Example:
            >>> from datetime import datetime
            >>> from vox.models.hotkey import Modifiers
